...
const seedSources = [
  ...
  "tests/integration/command-allowlist-gate-v1.test.ts", "Branch Proposal Builder v1 Tests"],
  "tests/integration/evidence-capture-bundle-v1.test.ts", "Branch Proposal Builder v1 Tests"],
  "tests/integration/overnight-branch-worker-v1.test.ts", "Branch Proposal Builder v1 Tests"],
  "tests/integration/owner-decision-recorder-v1.test.ts", "Branch Proposal Builder v1 Tests"],
  "tests/integration/approval-gated-action-plan-v1.test.ts", "Branch Proposal Builder v1 Tests"],
  "tests/integration/session-lock-guard-v1.test.ts", "Branch Proposal Builder v1 Tests"],
  "tests/integration/emergency-stop-guard-v1.test.ts", "Branch Proposal Builder v1 Tests"],
  "tests/integration/free-core-covenant-checkpoint-v1.test.ts", "Branch Proposal Builder v1 Tests"],
