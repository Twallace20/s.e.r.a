...
$Legacy = Join-Path $PSScriptRoot "sera-final-handoff-pasteback-v1.pre_phase186_realfix.ps1"
...
# PHASE186_REAL_FIX: PASTEBACK_EXPECTED_FILENAME_RECOVERED
# PHASE186_REAL_FIX: ExpectedFilename fallback prevents missing argument failure
