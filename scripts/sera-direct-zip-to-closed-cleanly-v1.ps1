...
$Legacy = Join-Path $PSScriptRoot "sera-direct-zip-to-closed-cleanly-v1.pre_phase186_realfix.ps1"
...
# PHASE186_REAL_FIX: ZIP_PATH_ARGUMENT_WAS_BLANK_RECOVERED
# PHASE186_REAL_FIX: ZIP_PATH_RESOLVED_FROM_EXPECTED_FILENAME
# PHASE186_REAL_FIX: ZIP_PATH_RESOLVED_FROM_DOWNLOADS13
# PHASE186_REAL_FIX: Missing ZIP errors include expectedFilename and searchedDirectories
